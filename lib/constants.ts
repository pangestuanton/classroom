...
export const ICONS = {
  ...
  `,
  google: `
    <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" class="w-4 h-4">
  ...
  `,
  inbox: `
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-12 h-12 mx-auto">
